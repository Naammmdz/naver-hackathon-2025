...
from api.routes import documents, query, workspaces, health, graph, tasks, boards, hitl, indexing, memories
...
app.include_router(memories.router, prefix="/api/v1", tags=["Memory"])
