...
import {
  ...
  y,
  zl
} from "./chunk-5J6PLIY2.js";
import "./chunk-WMPJNKWY.js";
import "./chunk-WW4U3SGQ.js";
import {
  arrow,
  autoUpdate,
  flip,
  ...
  shift,
  size
} from "./chunk-25WGZYRD.js";
import {
  Combination_default
} from "./chunk-Q5NWLW6G.js";
import {
  require_jsx_runtime
...
function useFocusWithin({
  ...
  const handleFocusIn = (0, import_react51.useCallback)(
    (event) => {
  ...
  const handleFocusOut = (0, import_react51.useCallback)(
    (event) => {
...
var MantineContext = (0, import_react77.createContext)(null);
function useMantineContext() {
  const ctx = (0, import_react77.useContext)(MantineContext);
  if (!ctx) {
...
function hslStringToRgba(hslaString) {
  ...
  const chroma = (1 - Math.abs(2 * l - 1)) * s2;
  const huePrime = h / 60;
...
// node_modules/@mantine/core/esm/core/MantineProvider/MantineThemeProvider/MantineThemeProvider.mjs
var MantineThemeContext = (0, import_react81.createContext)(null);
var useSafeMantineTheme = () => (0, import_react81.useContext)(MantineThemeContext) || DEFAULT_THEME;
function useMantineTheme() {
  const ctx = (0, import_react81.useContext)(MantineThemeContext);
  if (!ctx) {
    throw new Error(
...
function MantineThemeProvider({
  ...
  const mergedTheme = (0, import_react81.useMemo)(
...
function useProviderColorScheme({
  ...
  const media = (0, import_react88.useRef)(null);
  const [value, setValue] = (0, import_react88.useState)(() => manager.get(defaultColorScheme));
  const colorSchemeValue = forceColorScheme || value;
  const setColorScheme = (0, import_react88.useCallback)(
    (colorScheme) => {
      if (!forceColorScheme) {
  ...
  const clearColorScheme = (0, import_react88.useCallback)(() => {
...
function useRandomClassName() {
  const id = (0, import_react107.useId)().replace(/[:«»]/g, "");
  return `__m__-${id}`;
}
...
// node_modules/@mantine/core/esm/core/Box/Box.mjs
var _Box = (0, import_react108.forwardRef)(
  ({
    component,
    style,
    __vars,
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react109.forwardRef)((props, ref) => (0, import_jsx_runtime34.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  const Component = (0, import_react109.forwardRef)(ui);
  Component.extend = identity;
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react109.forwardRef)((props, ref) => (0, import_jsx_runtime34.jsx)(Component, { ...fixedProps, ...props, ref }));
...
function polymorphicFactory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react110.forwardRef)((props, ref) => (0, import_jsx_runtime35.jsx)(Component, { ...fixedProps, ...props, ref }));
    Extended.extend = Component.extend;
    Extended.displayName = `WithProps(${Component.displayName})`;
    return Extended;
  };
...
var DirectionContext = (0, import_react111.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react111.useContext)(DirectionContext);
}
...
function useCollapse({
  ...
  const el = (0, import_react112.useRef)(null);
  const collapsedStyles = getCollapsedStyles(keepMounted);
  const [styles, setStylesRaw] = (0, import_react112.useState)(opened ? {} : collapsedStyles);
  ...
  function getCollapseProps({ style = {}, refKey = "ref", ...rest } = {}) {
    ...
    if (import_react112.default.version.startsWith("18")) {
      if (!opened) {
        props.inert = "";
      }
    } else {
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = (0, import_react115.forwardRef)((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = (0, import_react115.useState)(0);
  const [height, setHeight] = (0, import_react115.useState)(0);
...
var ScrollAreaCorner = (0, import_react115.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
...
var ScrollAreaRoot = (0, import_react116.forwardRef)((_props, ref) => {
  const { type, scrollHideDelay, scrollbars, getStyles, ...others } = useProps(
    "ScrollAreaRoot",
    defaultProps2,
    _props
  );
  const [scrollArea, setScrollArea] = (0, import_react116.useState)(null);
  const [viewport, setViewport] = (0, import_react116.useState)(null);
  const [content, setContent] = (0, import_react116.useState)(null);
  const [scrollbarX, setScrollbarX] = (0, import_react116.useState)(null);
  const [scrollbarY, setScrollbarY] = (0, import_react116.useState)(null);
  const [cornerWidth, setCornerWidth] = (0, import_react116.useState)(0);
  const [cornerHeight, setCornerHeight] = (0, import_react116.useState)(0);
  const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react116.useState)(false);
  const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react116.useState)(false);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
var Scrollbar = (0, import_react118.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react118.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react118.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react118.useRef)("");
  ...
  (0, import_react118.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
var ScrollAreaScrollbarX = (0, import_react119.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const ctx = useScrollAreaContext();
    const [computedStyle, setComputedStyle] = (0, import_react119.useState)();
...
var ScrollAreaScrollbarY = (0, import_react120.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
var ScrollAreaScrollbarVisible = (0, import_react121.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react121.useRef)(null);
  const pointerOffsetRef = (0, import_react121.useRef)(0);
  const [sizes2, setSizes] = (0, import_react121.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
var ScrollAreaScrollbarAuto = (0, import_react122.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
    const { forceMount, ...scrollbarProps } = props;
    const [visible2, setVisible] = (0, import_react122.useState)(false);
...
var ScrollAreaScrollbarHover = (0, import_react123.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarScroll = (0, import_react124.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react124.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = (0, import_react125.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
var Thumb = (0, import_react126.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react126.useRef)(void 0);
...
var ScrollAreaThumb = (0, import_react126.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaViewport = (0, import_react127.forwardRef)(
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react128.useState)(false);
  const [verticalThumbVisible, setVerticalThumbVisible] = (0, import_react128.useState)(false);
  const [horizontalThumbVisible, setHorizontalThumbVisible] = (0, import_react128.useState)(false);
  ...
  const localViewportRef = (0, import_react128.useRef)(null);
...
var ScrollAreaAutosize = factory((props, ref) => {
  ...
  const viewportObserverRef = (0, import_react128.useRef)(null);
  const combinedViewportRef = useMergeRefs([viewportRef, viewportObserverRef]);
  const [overflowing, setOverflowing] = (0, import_react128.useState)(false);
  const didMount = (0, import_react128.useRef)(false);
  (0, import_react128.useEffect)(() => {
    if (!onOverflowChange) {
      return;
    }
    ...
    const update = () => {
      ...
      if (isOverflowing !== overflowing) {
        if (didMount.current) {
          onOverflowChange == null ? void 0 : onOverflowChange(isOverflowing);
        } else {
          didMount.current = true;
          if (isOverflowing) {
            onOverflowChange == null ? void 0 : onOverflowChange(true);
          }
        }
...
// node_modules/@mantine/core/esm/utils/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow = (0, import_react133.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrap({
  ...
  return (0, import_react140.cloneElement)(children, { [refProp]: ref });
}
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react142.cloneElement)(children, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
    ...
    ...!ctx.controlled ? {
      onClick: () => {
        var _a, _b;
        ctx.onToggle();
        (_b = (_a = children.props).onClick) == null ? void 0 : _b.call(_a);
      }
    } : null
  });
});
...
function Popover(_props) {
  ...
  const [dropdownVisible, setDropdownVisible] = (0, import_react145.useState)(opened ?? defaultOpened ?? false);
  const positionRef = (0, import_react145.useRef)(position);
  ...
  }, [transitionProps == null ? void 0 : transitionProps.onExited, onExitTransitionEnd, preventPositionChangeWhenVisible, position]);
  ...
  return (0, import_jsx_runtime67.jsxs)(
    PopoverContextProvider,
    {
      value: {
        ...
        resolvedStyles,
        floatingStrategy,
        referenceHidden: hideDetached && env !== "test" ? (_g = popover.floating.middlewareData.hide) == null ? void 0 : _g.referenceHidden : false
      },
      children: [
        children,
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react146.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsxs)(Box, { component: "span", className: clsx_default(classes7.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react147.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime69.jsxs)(Box, { component: "span", className: clsx_default(classes7.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react148.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime70.jsx)(Box, { component: "span", className: clsx_default(classes7.ovalLoader, className), ...others, ref }));
...
var CloseIcon = (0, import_react153.forwardRef)(
...
function filterFalsyChildren(children) {
  return import_react155.Children.toArray(children).filter(Boolean);
}
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime95.jsx)(import_react176.Fragment, { children: inputContainer(children) }, "input");
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react183.useRef)(-1);
  const closeTimeout = (0, import_react183.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react183.useEffect)(() => clearTimeouts, []);
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index3) => (0, import_react195.createElement)(
    "div",
    {
...
function AppShellMediaStyles({
  ...
  return (0, import_jsx_runtime126.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react211.useState)(true);
  const resizingTimeout = (0, import_react211.useRef)(-1);
  const disabledTimeout = (0, import_react211.useRef)(-1);
  useWindowEvent("resize", () => {
    setResizing(true);
    clearTimeout(resizingTimeout.current);
    resizingTimeout.current = window.setTimeout(
      () => (0, import_react211.startTransition)(() => {
        setResizing(false);
      }),
      200
    );
...
var AppShell = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime129.jsxs)(AppShellProvider, { value: { getStyles, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
var ComboboxClearButton = (0, import_react216.forwardRef)(
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react220.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react221.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxOption = factory((_props, ref) => {
  ...
  const ctx = useComboboxContext();
  const uuid = (0, import_react225.useId)();
  const _id = id || uuid;
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react228.cloneElement)(children, {
    ...targetProps,
    ...others
  });
...
function useCombobox({
  ...
  const listId = (0, import_react229.useRef)(null);
  const selectedOptionIndex = (0, import_react229.useRef)(-1);
  const searchRef = (0, import_react229.useRef)(null);
  const targetRef = (0, import_react229.useRef)(null);
  const focusSearchTimeout = (0, import_react229.useRef)(-1);
  const focusTargetTimeout = (0, import_react229.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react229.useRef)(-1);
  const openDropdown = (0, import_react229.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react229.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react229.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react229.useCallback)(() => {
  ...
  const selectOption = (0, import_react229.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react229.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react229.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react229.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react229.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react229.useCallback)(
  ...
  const resetSelectedOption = (0, import_react229.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react229.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react229.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react229.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => {
      var _a;
      return (_a = searchRef.current) == null ? void 0 : _a.focus();
    }, 0);
  }, []);
  const focusTarget = (0, import_react229.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => {
      var _a;
      return (_a = targetRef.current) == null ? void 0 : _a.focus();
    }, 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react229.useCallback)(() => selectedOptionIndex.current, []);
...
var InlineInput = (0, import_react231.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
    ...
    return (0, import_jsx_runtime147.jsx)(
      Box,
      {
        ...
        size: size2,
        ...others,
        children: (0, import_jsx_runtime147.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime147.jsxs)("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && (0, import_jsx_runtime147.jsx)(
                  Box,
                  {
                    component: labelElement,
                ...
                description && (0, import_jsx_runtime147.jsx)(Input.Description, { size: size2, __inheritStyles: false, ...getStyles("description"), children: description }),
                error && typeof error !== "boolean" && (0, import_jsx_runtime147.jsx)(Input.Error, { size: size2, __inheritStyles: false, ...getStyles("error"), children: error })
              ] })
            ]
          }
        )
...
var CheckboxGroupContext = (0, import_react232.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react232.useContext)(CheckboxGroupContext);
...
var CheckboxCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime149.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: (0, import_jsx_runtime149.jsx)(
    UnstyledButton,
    {
      ref,
...
function InputsGroupFieldset({ children, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime150.jsx)(import_jsx_runtime150.Fragment, { children });
  }
  return (0, import_jsx_runtime150.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup/CheckboxGroup.mjs
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", null, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime151.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime151.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime151.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return (0, import_jsx_runtime152.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: (0, import_jsx_runtime152.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return (0, import_jsx_runtime152.jsx)(CheckIcon, { ...others });
}
...
var CheckboxIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime153.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime153.jsx)(Icon, { indeterminate, ...getStyles("icon") })
    }
  );
});
...
var Checkbox = factory((_props, forwardedRef) => {
  ...
  const fallbackRef = (0, import_react239.useRef)(null);
  ...
  return (0, import_jsx_runtime154.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime154.jsxs)(Box, { ...getStyles("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime154.jsx)(Icon, { indeterminate, ...getStyles("icon") })
      ] })
    }
  );
});
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && (0, import_jsx_runtime155.jsx)(CheckIcon, { className: classes23.optionsDropdownCheckIcon });
    const defaultContent = (0, import_jsx_runtime155.jsxs)(import_jsx_runtime155.Fragment, { children: [
      checkIconPosition === "left" && check,
      (0, import_jsx_runtime155.jsx)("span", { children: data.label }),
  ...
  const options = data.items.map((item) => (0, import_jsx_runtime155.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return (0, import_jsx_runtime155.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => (0, import_jsx_runtime155.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return (0, import_jsx_runtime155.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, "data-composed": true, children: (0, import_jsx_runtime155.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
    withScrollArea ? (0, import_jsx_runtime155.jsx)(
      ScrollArea.Autosize,
      {
    ...
    isEmpty && nothingFoundMessage && (0, import_jsx_runtime155.jsx)(Combobox.Empty, { children: nothingFoundMessage })
  ] }) });
}
...
var Autocomplete = factory((_props, ref) => {
  ...
  const clearButton = (0, import_jsx_runtime156.jsx)(
  ...
  return (0, import_jsx_runtime156.jsxs)(
    Combobox,
    {
      ...
      ...comboboxProps,
      children: [
        (0, import_jsx_runtime156.jsx)(Combobox.Target, { autoComplete, children: (0, import_jsx_runtime156.jsx)(
          InputBase,
          {
            ref,
            ...others,
...
var AvatarGroupContext = (0, import_react241.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react241.useContext)(AvatarGroupContext);
...
var AvatarGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime157.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime157.jsx)(Box, { ref, ...getStyles("group"), ...others }) });
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react243.useState)(!src);
  const getStyles = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react243.useEffect)(() => setError(!src), [src]);
  return (0, import_jsx_runtime159.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error || !src ? (0, import_jsx_runtime159.jsx)("span", { ...getStyles("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime159.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime159.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles("image"),
...
var Badge = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime161.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime161.jsx)("span", { ...getStyles("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime161.jsx)("span", { ...getStyles("label"), children }),
        rightSection && (0, import_jsx_runtime161.jsx)("span", { ...getStyles("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Blockquote = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime162.jsxs)(Box, { component: "blockquote", ref, ...getStyles("root"), ...others, children: [
    icon && (0, import_jsx_runtime162.jsx)("span", { ...getStyles("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime162.jsx)("cite", { ...getStyles("cite"), children: cite })
  ] });
});
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react247.Children.toArray(children).reduce((acc, child, index3, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react247.cloneElement)(child, {
      ...getStyles("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index3
    }) : (0, import_react247.createElement)("div", { ...getStyles("breadcrumb"), key: index3 }, child);
    acc.push(item);
    if (index3 !== array.length - 1) {
      acc.push(
        (0, import_react247.createElement)(Box, { ...getStyles("separator"), key: `separator-${index3}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime163.jsx)(Box, { ref, ...getStyles("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime164.jsxs)(UnstyledButton, { ...getStyles("root"), ref, ...others, children: [
    (0, import_jsx_runtime164.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles("burger") }),
    children
  ] });
});
...
var ButtonGroupSection = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime166.jsx)(Box, { ...getStyles("groupSection"), ref, variant, ...others });
});
...
var Button = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime167.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        typeof loading === "boolean" && (0, import_jsx_runtime167.jsx)(Transition, { mounted: loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime167.jsx)(Box, { component: "span", ...getStyles("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime167.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime167.jsxs)("span", { ...getStyles("inner"), children: [
          leftSection && (0, import_jsx_runtime167.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime167.jsx)(Box, { component: "span", mod: { loading }, ...getStyles("label"), children }),
          rightSection && (0, import_jsx_runtime167.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react254.Children.toArray(children);
  const content = _children.map((child, index3) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react254.cloneElement)(child, {
  ...
  return (0, import_jsx_runtime170.jsx)(CardProvider, { value: { getStyles }, children: (0, import_jsx_runtime170.jsx)(Paper, { ref, unstyled, ...getStyles("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime171.jsx)(Box, { ref, mod: [{ inline: inline2 }, mod], ...getStyles("root"), ...others });
});
...
function ChipGroup(props) {
  ...
  return (0, import_jsx_runtime173.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children });
}
      ...
      children: [
        ...
        (0, import_jsx_runtime174.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime174.jsx)("span", { ...getStyles("iconWrapper"), children: icon || (0, import_jsx_runtime174.jsx)(CheckIcon, { ...getStyles("checkIcon") }) }),
              (0, import_jsx_runtime174.jsx)("span", { children })
            ]
          }
        )
      ]
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime176.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime176.jsx)("span", { ...getStyles("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime176.jsx)("span", { ...getStyles("shadowOverlay") }),
        (0, import_jsx_runtime176.jsx)("span", { ...getStyles("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime176.jsx)("span", { ...getStyles("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react262.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime178.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react263.useState)({ y: 0, x: value / maxValue });
  ...
  const layers = overlays.map((overlay, index3) => (0, import_react263.createElement)("div", { ...getStyles("sliderOverlay"), style: overlay, key: index3 }));
...
function hslaToHsva({ h, s: s2, l, a }) {
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var AlphaSlider = (0, import_react264.forwardRef)((props, ref) => {
...
function hsvaToRgbaObject({ h, s: s2, v: v2, a }) {
  const _h = h / 360 * 6;
  const _s = s2 / 100;
  const _v = v2 / 100;
...
function hsvaToHsl({ h, s: s2, v: v2, a }, includeAlpha) {
  const hh = (200 - s2) * v2 / 100;
  const result = {
    h: Math.round(h),
    s: Math.round(hh > 0 && hh < 200 ? s2 * v2 / 100 / (hh <= 100 ? hh : 200 - hh) * 100 : 0),
    l: Math.round(hh / 2)
  };
  if (!includeAlpha) {
...
var HueSlider = (0, import_react265.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react266.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
  const positionRef = (0, import_react266.useRef)(position);
  const { ref } = useMove(
    ({ x, y: y2 }) => {
      positionRef.current = { x, y: y2 };
  ...
  return (0, import_jsx_runtime182.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime182.jsx)(Thumb2, { position, ...getStyles("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react267.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index3) => (0, import_react267.createElement)(
      ColorSwatch,
      {
      ...
      value === color && (0, import_jsx_runtime183.jsx)(CheckIcon, { size: "35%", color: luminance(color) < 0.5 ? "white" : "black" })
    ));
    return (0, import_jsx_runtime183.jsx)(Box, { ...ctx.getStyles("swatches"), ref, ...others, children: colors });
  }
);
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react268.useRef)(format2 || "hex");
  const valueRef = (0, import_react268.useRef)("");
  const scrubTimeoutRef = (0, import_react268.useRef)(-1);
  const isScrubbingRef = (0, import_react268.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react268.useState)(parseColor(_value));
  const startScrubbing = () => {
  ...
  return (0, import_jsx_runtime184.jsx)(ColorPickerProvider, { value: { getStyles, unstyled }, children: (0, import_jsx_runtime184.jsxs)(
    Box,
    {
      ref,
      ...getStyles("wrapper"),
      ...
      ...others,
      children: [
        withPicker && (0, import_jsx_runtime184.jsxs)(import_jsx_runtime184.Fragment, { children: [
          (0, import_jsx_runtime184.jsx)(
            Saturation,
            {
              value: parsed,
              onChange: handleChange,
              onChangeEnd: ({ s: s2, v: v2 }) => onChangeEnd == null ? void 0 : onChangeEnd(convertHsvaTo(formatRef.current, { ...parsed, s: s2, v: v2 })),
              color: _value,
              size: size2,
              focusable: focusable2,
              saturationLabel,
          ...
          (0, import_jsx_runtime184.jsxs)("div", { ...getStyles("body"), children: [
            (0, import_jsx_runtime184.jsxs)("div", { ...getStyles("sliders"), children: [
              (0, import_jsx_runtime184.jsx)(
                HueSlider,
                {
                  value: parsed.h,
              ...
              withAlpha && (0, import_jsx_runtime184.jsx)(
                AlphaSlider,
                {
                  value: parsed.a,
        ...
        Array.isArray(swatches) && (0, import_jsx_runtime184.jsx)(
          Swatches,
          {
            data: swatches,
            swatchesPerRow,
...
function EyeDropperIcon({ style, ...others }) {
  return (0, import_jsx_runtime185.jsxs)(
    "svg",
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime185.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M12 3l0 4" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M12 21l0 -3" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M3 12l4 0" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M21 12l-3 0" }),
        (0, import_jsx_runtime185.jsx)("path", { d: "M12 12l0 .01" })
      ]
    }
  );
}
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react269.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react269.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const eyeDropper = (0, import_jsx_runtime186.jsx)(
    ActionIcon,
    {
      ...eyeDropperButtonProps,
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime186.jsx)(EyeDropperIcon, { ...getStyles("eyeDropperIcon") })
    }
  );
  ...
  return (0, import_jsx_runtime186.jsx)(
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime186.jsxs)(
        Popover,
        {
          __staticSelector: "ColorInput",
          ...
          children: [
            (0, import_jsx_runtime186.jsx)(Popover.Target, { children: (0, import_jsx_runtime186.jsx)(
              Input,
              {
                autoComplete: "off",
                ...others,
                ...
                leftSection: leftSection || (withPreview ? (0, import_jsx_runtime186.jsx)(
                  ColorSwatch,
                  {
...
function CopyButton(props) {
  ...
  return (0, import_jsx_runtime188.jsx)(import_jsx_runtime188.Fragment, { children: children({ copy, copied: clipboard.copied, ...others }) });
}
...
var Dialog = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime189.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime189.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime189.jsxs)(
        Paper,
        {
          unstyled,
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime189.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles("closeButton") }),
            children
          ]
        }
      ) })
...
var Divider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime190.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime190.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles("label"), children: label })
    }
  );
});
...
var DrawerContent = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime194.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime194.jsx)(Scroll, { style: { height: "calc(100vh - var(--drawer-offset) * 2)" }, children })
    }
  );
});
...
var DrawerRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime197.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles, radius }, children: (0, import_jsx_runtime197.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles("root"),
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react282.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react282.useState)(getDefaultZIndex("modal"));
...
var Drawer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime200.jsxs)(
    DrawerRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime200.jsx)(
          DrawerOverlay,
          {
        ...
        (0, import_jsx_runtime200.jsxs)(DrawerContent, { __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false, children: [
          hasHeader && (0, import_jsx_runtime200.jsxs)(DrawerHeader, { children: [
            title && (0, import_jsx_runtime200.jsx)(DrawerTitle, { children: title }),
            withCloseButton && (0, import_jsx_runtime200.jsx)(DrawerCloseButton, { ...closeButtonProps })
          ] }),
          (0, import_jsx_runtime200.jsx)(DrawerBody, { children })
        ] })
      ]
    }
  );
...
var Fieldset = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime201.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime201.jsx)("legend", { ...getStyles("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var FileButton = (0, import_react286.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
    ...
    const inputRef = (0, import_react286.useRef)(null);
    const onClick = () => {
      var _a;
...
var DefaultValue = ({ value }) => (0, import_jsx_runtime203.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value == null ? void 0 : value.name });
var defaultProps46 = {
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react287.useRef)(null);
  const { resolvedClassNames, resolvedStyles } = useResolvedStylesApi({
    classNames,
    styles,
    props
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? (0, import_jsx_runtime203.jsx)(
    CloseButton,
    {
      ...clearButtonProps,
      variant: "subtle",
  ...
  return (0, import_jsx_runtime203.jsx)(
    FileButton,
    {
      ...
      children: (fileButtonProps) => (0, import_jsx_runtime203.jsx)(
        InputBase,
        {
          ...
          styles,
          attributes,
          children: !hasValue ? (0, import_jsx_runtime203.jsx)(
            Input.Placeholder,
            {
              __staticSelector: "FileInput",
              classNames: resolvedClassNames,
          ...
          ) : (0, import_jsx_runtime203.jsx)(ValueComponent, { value: _value })
        }
      )
    }
  );
...
var Grid = factory((_props, ref) => {
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime208.jsxs)(GridProvider, { value: { getStyles, grow, columns, breakpoints, type }, children: [
      (0, import_jsx_runtime208.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime208.jsx)("div", { ...getStyles("container"), children: (0, import_jsx_runtime208.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime208.jsx)("div", { ...getStyles("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime208.jsxs)(GridProvider, { value: { getStyles, grow, columns, breakpoints, type }, children: [
    (0, import_jsx_runtime208.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime208.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime208.jsx)("div", { ...getStyles("inner"), children }) })
  ] });
});
...
var Mark = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime210.jsx)(Box, { component: "mark", ref, variant, ...getStyles("root"), ...others });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime211.jsx)(Text, { unstyled, ref, ...others, __staticSelector: "Highlight", children: highlightChunks.map(
    ({ chunk, highlighted }, i) => highlighted ? (0, import_jsx_runtime211.jsx)(
      Mark,
      {
        unstyled,
        color,
      ...
      i
    ) : (0, import_jsx_runtime211.jsx)("span", { children: chunk }, i)
  ) });
});
...
var HoverCardGroupContext = (0, import_react297.createContext)(false);
var HoverCardGroupProvider = HoverCardGroupContext.Provider;
var useHoverCardGroupContext = () => (0, import_react297.useContext)(HoverCardGroupContext);
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime213.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children });
}
...
function HoverCardGroup(props) {
  ...
  return (0, import_jsx_runtime214.jsx)(HoverCardGroupProvider, { value: true, children: (0, import_jsx_runtime214.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
var HoverCardTarget = (0, import_react301.forwardRef)((props, ref) => {
  ...
  if (withinGroup && ctx.getReferenceProps && ctx.reference) {
    ...
    return (0, import_jsx_runtime215.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react301.cloneElement)(
      children,
...
function useHoverCard(settings) {
  ...
  const withinGroup = useHoverCardGroupContext();
  const uid = useId();
  const openTimeout = (0, import_react302.useRef)(-1);
  const closeTimeout = (0, import_react302.useRef)(-1);
  const clearTimeouts = (0, import_react302.useCallback)(() => {
    window.clearTimeout(openTimeout.current);
    window.clearTimeout(closeTimeout.current);
  }, []);
  const onChange = (0, import_react302.useCallback)(
    (_opened) => {
      ...
      if (_opened) {
        setCurrentId(uid);
        (_a = settings.onOpen) == null ? void 0 : _a.call(settings);
      } else {
        (_b = settings.onClose) == null ? void 0 : _b.call(settings);
      }
    },
  ...
  const openDropdown = (0, import_react302.useCallback)(() => {
    if (withinGroup) {
      return;
    }
    clearTimeouts();
  ...
  const closeDropdown = (0, import_react302.useCallback)(() => {
    if (withinGroup) {
      return;
    }
    clearTimeouts();
  ...
  (0, import_react302.useEffect)(() => () => clearTimeouts(), [clearTimeouts]);
  return {
    opened,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime216.jsx)(
    HoverCardContextProvider,
    {
      ...
      children: (0, import_jsx_runtime216.jsx)(Popover, { ...others, opened: hoverCard.opened, __staticSelector: "HoverCard", children })
    }
  );
}
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react305.useState)(!src);
  (0, import_react305.useEffect)(() => setError(!src), [src]);
  const getStyles = useStyles({
    name: "Image",
    classes: classes49,
    props,
...
var Indicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime219.jsxs)(Box, { ref, ...getStyles("root"), mod: [{ inline: inline2 }, mod], ...others, children: [
    !disabled && (0, import_jsx_runtime219.jsx)(
      Box,
      {
...
var index = import_react308.useLayoutEffect;

// node_modules/use-latest/dist/use-latest.esm.js
var useLatest = function useLatest2(value) {
  var ref = import_react309.default.useRef(value);
  index(function() {
    ref.current = value;
  });
  return ref;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = import_react310.default.useRef();
  return import_react310.default.useCallback(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react312.useState)(validateJson(_value, deserialize));
...
var Kbd = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime222.jsx)(Box, { component: "kbd", ref, ...getStyles("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime224.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime224.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        _icon && (0, import_jsx_runtime224.jsx)("span", { ...ctx.getStyles("itemIcon", stylesApiProps), children: _icon }),
        (0, import_jsx_runtime224.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children })
      ] })
    }
  );
});
...
var List = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime225.jsx)(ListProvider, { value: { center, icon, getStyles }, children: (0, import_jsx_runtime225.jsx)(
    Box,
    {
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime226.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime226.jsxs)(Box, { ...getStyles("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime226.jsx)(Loader, { ...getStyles("loader"), unstyled, ...loaderProps }),
    (0, import_jsx_runtime226.jsx)(
      Overlay,
      {
        ..._overlayProps,
        ...getStyles("overlay"),
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react320.useRef)(null);
  const ctx = useMenuContext();
  ...
  return (0, import_jsx_runtime229.jsxs)(
    Popover.Dropdown,
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        ctx.withInitialFocusPlaceholder && (0, import_jsx_runtime229.jsx)("div", { tabIndex: -1, "data-autofocus": true, "data-mantine-stop-propagation": true, style: { outline: 0 } }),
        children
      ]
    }
  );
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react322.useRef)(null);
  ...
  return (0, import_jsx_runtime231.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime231.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime231.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        rightSection && (0, import_jsx_runtime231.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var MenuSubDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react324.useRef)(null);
  const ctx = useMenuContext();
  const subCtx = useSubMenuContext();
  const handleMouseEnter = createEventHandler(onMouseEnter, subCtx == null ? void 0 : subCtx.open);
  const handleMouseLeave = createEventHandler(onMouseLeave, subCtx == null ? void 0 : subCtx.close);
...
var MenuSubItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react325.useRef)(null);
  const _others = others;
  const colors = color ? theme.variantColorResolver({ color, theme, variant: "light" }) : void 0;
  const parsedThemeColor = color ? parseThemeColor({ color, theme }) : null;
  const handleKeydown = createEventHandler(_others.onKeyDown, (event) => {
    if (event.key === "ArrowRight") {
      subCtx == null ? void 0 : subCtx.open();
      subCtx == null ? void 0 : subCtx.focusFirstItem();
    }
    if (event.key === "ArrowLeft" && (subCtx == null ? void 0 : subCtx.parentContext)) {
  ...
  const handleMouseEnter = createEventHandler(_others.onMouseEnter, subCtx == null ? void 0 : subCtx.open);
  const handleMouseLeave = createEventHandler(_others.onMouseLeave, subCtx == null ? void 0 : subCtx.close);
  return (0, import_jsx_runtime234.jsxs)(
    UnstyledButton,
    {
      onMouseDown: (event) => event.preventDefault(),
      ...others,
      ...
      children: [
        leftSection && (0, import_jsx_runtime234.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime234.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        (0, import_jsx_runtime234.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection || (0, import_jsx_runtime234.jsx)(AccordionChevron, { ...ctx.getStyles("chevron"), size: 14 }) })
      ]
    }
  );
});
...
function MenuSubTarget({ children, refProp }) {
  ...
  useMenuContext();
  return (0, import_jsx_runtime235.jsx)(Popover.Target, { refProp, popupType: "menu", children });
}
...
function MenuSub(_props) {
  ...
  const focusFirstItem = () => window.setTimeout(() => {
    var _a, _b;
    (_b = (_a = document.getElementById(`${id}-dropdown`)) == null ? void 0 : _a.querySelectorAll("[data-menu-item]:not([data-disabled])")[0]) == null ? void 0 : _b.focus();
  }, 16);
  const focusParentItem = () => window.setTimeout(() => {
    var _a;
    (_a = document.getElementById(`${id}-target`)) == null ? void 0 : _a.focus();
  }, 16);
  return (0, import_jsx_runtime236.jsx)(
    SubMenuProvider,
    {
      ...
      children: (0, import_jsx_runtime236.jsx)(Popover, { opened, withinPortal: false, withArrow: false, id, ...others, children })
    }
  );
}
...
var MenuTarget = (0, import_react328.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime237.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react328.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react329.useState)(false);
  const close = () => {
    setOpened(false);
...
var ModalContent = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime242.jsx)(
    ModalBaseContent,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime242.jsx)(
        Scroll,
        {
          style: {
...
var ModalRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime245.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles, fullScreen }, children: (0, import_jsx_runtime245.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react337.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react337.useState)(getDefaultZIndex("modal"));
...
var Modal = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime248.jsxs)(
    ModalRoot,
    {
      ref,
      radius,
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime248.jsx)(
          ModalOverlay,
          {
            visible: overlayVisible,
            transitionProps: ctx && stackId ? { duration: 0 } : void 0,
        ...
        (0, import_jsx_runtime248.jsxs)(
          ModalContent,
          {
            ...
            children: [
              hasHeader && (0, import_jsx_runtime248.jsxs)(ModalHeader, { children: [
                title && (0, import_jsx_runtime248.jsx)(ModalTitle, { children: title }),
                withCloseButton && (0, import_jsx_runtime248.jsx)(ModalCloseButton, { ...closeButtonProps })
              ] }),
              (0, import_jsx_runtime248.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
var PillGroup = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime251.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime251.jsx)(Box, { ref, size: _size, ...getStyles("group"), ...others }) });
});
...
var Pill = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime252.jsxs)(
    Box,
    {
      component: "span",
      ref,
      ...
      ...others,
      children: [
        (0, import_jsx_runtime252.jsx)("span", { ...getStyles("label"), children }),
        withRemoveButton && (0, import_jsx_runtime252.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react346.useRef)(null);
  return (0, import_jsx_runtime254.jsx)(PillsInputProvider, { value: { fieldRef, size: size2, disabled, hasError: !!error, variant }, children: (0, import_jsx_runtime254.jsx)(
    InputBase,
    {
      size: size2,
      error,
...
var MultiSelect = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const retainedSelectedOptions = (0, import_react348.useRef)({});
  const combobox = useCombobox({
    opened: dropdownOpened,
    defaultOpened: defaultDropdownOpened,
    onDropdownOpen,
  ...
  const values2 = _value.map((item, index3) => {
    ...
    return (0, import_jsx_runtime256.jsx)(
      Pill,
      {
        ...
        disabled,
        ...getStyles("pill"),
        children: (optionData == null ? void 0 : optionData.label) || item
      },
      `${item}-${index3}`
    );
  });
  ...
  const clearButton = (0, import_jsx_runtime256.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime256.jsxs)(import_jsx_runtime256.Fragment, { children: [
    (0, import_jsx_runtime256.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime256.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime256.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "MultiSelect",
              ...
              disabled,
              radius,
              __defaultRightSection: (0, import_jsx_runtime256.jsx)(
                Combobox.Chevron,
                {
                  size: size2,
                  error,
              ...
              mod,
              attributes,
              children: (0, import_jsx_runtime256.jsxs)(
                Pill.Group,
                {
                  attributes,
                  disabled,
                  ...
                  children: [
                    values2,
                    (0, import_jsx_runtime256.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime256.jsx)(
                      PillsInput.Field,
                      {
                        ...rest,
                        ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => (0, import_jsx_runtime257.jsx)(NativeSelectOption, { data: item }, item.value));
    return (0, import_jsx_runtime257.jsx)("optgroup", { label: data.group, children: items });
  }
  const { value, label, ...others } = data;
  return (0, import_jsx_runtime257.jsx)("option", { value: data.value, ...others, children: data.label }, data.value);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index3) => (0, import_jsx_runtime258.jsx)(NativeSelectOption, { data: item }, index3));
  return (0, import_jsx_runtime258.jsx)(
    InputBase,
    {
      ...
      error,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime258.jsx)(ComboboxChevron, { size: size2, error, unstyled }),
...
var NavLink = polymorphicFactory((_props, ref) => {
  ...
  return (0, import_jsx_runtime259.jsxs)(import_jsx_runtime259.Fragment, { children: [
    (0, import_jsx_runtime259.jsxs)(
      UnstyledButton,
      {
        ...getStyles("root"),
        component: "a",
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime259.jsx)(Box, { component: "span", ...getStyles("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime259.jsxs)(Box, { ...getStyles("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime259.jsx)(Box, { component: "span", ...getStyles("label"), children: label }),
            (0, import_jsx_runtime259.jsx)(Box, { component: "span", mod: { active }, ...getStyles("description"), children: description })
          ] }),
          (withChildren || rightSection !== void 0) && (0, import_jsx_runtime259.jsx)(
            Box,
            {
              ...getStyles("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection !== void 0 ? rightSection : (0, import_jsx_runtime259.jsx)(AccordionChevron, { ...getStyles("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime259.jsx)(Collapse, { in: _opened, ...getStyles("collapse"), children: (0, import_jsx_runtime259.jsx)("div", { ...getStyles("children"), children }) })
  ] });
});
...
var Notification = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime260.jsxs)(
    Box,
    {
      ...getStyles("root"),
      ...
      ...others,
      children: [
        icon && !loading && (0, import_jsx_runtime260.jsx)("div", { ...getStyles("icon"), children: icon }),
        loading && (0, import_jsx_runtime260.jsx)(Loader, { size: 28, color, ...loaderProps, ...getStyles("loader") }),
        (0, import_jsx_runtime260.jsxs)("div", { ...getStyles("body"), children: [
          title && (0, import_jsx_runtime260.jsx)("div", { ...getStyles("title"), children: title }),
          (0, import_jsx_runtime260.jsx)(Box, { ...getStyles("description"), mod: { "data-with-title": !!title }, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime260.jsx)(
          CloseButton,
          {
            iconSize: 16,
            color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react352.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react352.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react352.useState)(function() {
  ...
  (0, import_react352.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react352.useRef)();
  var lastUpdatedValue = (0, import_react352.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react352.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react352.useRef)(null);
  var timeout = (0, import_react352.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react352.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect = typeof window !== "undefined" ? import_react352.useLayoutEffect : import_react352.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react352.default.createElement(import_react352.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react352.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react352.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react352.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react352.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  ...
  return (0, import_jsx_runtime261.jsx)(NumericFormat, { displayType: "text", value, ...others });
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react354.useRef)(null);
  const onStepTimeoutRef = (0, import_react354.useRef)(null);
  const stepCountRef = (0, import_react354.useRef)(0);
  ...
  const incrementRef = (0, import_react354.useRef)(noop);
  ...
  const decrementRef = (0, import_react354.useRef)(noop);
  ...
  const handleKeyDown = (event) => {
    ...
    if (event.key === "ArrowUp") {
      event.preventDefault();
      (_a = incrementRef.current) == null ? void 0 : _a.call(incrementRef);
    }
    if (event.key === "ArrowDown") {
      event.preventDefault();
      (_b = decrementRef.current) == null ? void 0 : _b.call(decrementRef);
    }
  };
  ...
  const controls = (0, import_jsx_runtime263.jsxs)("div", { ...getStyles("controls"), children: [
    (0, import_jsx_runtime263.jsx)(
      UnstyledButton,
      {
        ...
        children: (0, import_jsx_runtime263.jsx)(NumberInputChevron, { direction: "up" })
      }
    ),
    (0, import_jsx_runtime263.jsx)(
      UnstyledButton,
      {
        ...
        onPointerUp: onStepDone,
        onPointerLeave: onStepDone,
        children: (0, import_jsx_runtime263.jsx)(NumberInputChevron, { direction: "down" })
      }
    )
  ] });
...
function PaginationIcon({ style, children, path, ...others }) {
  return (0, import_jsx_runtime266.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime266.jsx)("path", { d: path, fill: "currentColor" })
    }
  );
}
var PaginationNextIcon = (props) => (0, import_jsx_runtime266.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => (0, import_jsx_runtime266.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => (0, import_jsx_runtime266.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => (0, import_jsx_runtime266.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => (0, import_jsx_runtime266.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  ...
  const ctx = usePaginationContext();
  return (0, import_jsx_runtime267.jsx)(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others, children: (0, import_jsx_runtime267.jsx)(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react358.forwardRef)((props, ref) => {
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index3) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime269.jsx)(PaginationDots, { icon: dotsIcon }, index3);
    }
  ...
  return (0, import_jsx_runtime269.jsx)(import_jsx_runtime269.Fragment, { children: items });
}
...
var PaginationRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime270.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime270.jsx)(Box, { ref, ...getStyles("root"), ...others })
    }
  );
});
...
var Pagination = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime271.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime271.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime271.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }),
    withControls && (0, import_jsx_runtime271.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }),
    withPages && (0, import_jsx_runtime271.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime271.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }),
    withEdges && (0, import_jsx_runtime271.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })
  ] }) });
});
...
var PasswordToggleIcon = ({
  ...
  "svg",
  {
    ...
    children: (0, import_jsx_runtime272.jsx)(
      "path",
      {
...
var PasswordInput = factory((_props, ref) => {
  ...
  const _describedBy = `${hasError ? errorId : ""} ${hasDescription ? descriptionId : ""}`;
  const describedBy = _describedBy.trim().length > 0 ? _describedBy.trim() : void 0;
  const visibilityToggleButton = (0, import_jsx_runtime273.jsx)(
    ActionIcon,
    {
      ...
      children: (0, import_jsx_runtime273.jsx)(VisibilityToggleIcon, { reveal: _visible })
    }
  );
...
var PinInput = factory((props, ref) => {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react362.useState)(-1);
  ...
  const inputsRef = (0, import_react362.useRef)([]);
  const validate = (code) => {
    const re2 = type instanceof RegExp ? type : type && type in regex ? regex[type] : null;
    return re2 == null ? void 0 : re2.test(code);
  };
  ...
  return (0, import_jsx_runtime274.jsxs)(import_jsx_runtime274.Fragment, { children: [
    (0, import_jsx_runtime274.jsx)(
      Group,
      {
        ...
        __size: size2,
        dir: "ltr",
        children: _value.map((char, index3) => (0, import_react362.createElement)(
          Input,
          {
            component: "input",
            ...getStyles("pinInput", {
    ...
    (0, import_jsx_runtime274.jsx)("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps })
  ] });
});
...
var ProgressRoot = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime277.jsx)(ProgressProvider, { value: { getStyles, autoContrast }, children: (0, import_jsx_runtime277.jsx)(Box, { ref, mod: [{ orientation }, mod], ...getStyles("root"), ...others }) });
});
...
var RadioCard = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime282.jsx)(RadioCardProvider, { value: { checked: _checked }, children: (0, import_jsx_runtime282.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", null, props);
  ...
  return (0, import_jsx_runtime283.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size2, name: _name }, children: (0, import_jsx_runtime283.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime283.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size2, style, ...others }) {
  return (0, import_jsx_runtime284.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: (0, import_jsx_runtime284.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
var RadioIndicator = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime285.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime285.jsx)(Icon, { ...getStyles("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime286.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime286.jsxs)(Box, { ...getStyles("inner"), mod: { "label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime286.jsx)(Icon, { ...getStyles("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
function StarIcon(props) {
  ...
  return (0, import_jsx_runtime288.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime288.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return (0, import_jsx_runtime289.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  return (0, import_jsx_runtime290.jsxs)(import_jsx_runtime290.Fragment, { children: [
    !readOnly && (0, import_jsx_runtime290.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
      ...
      Box,
      {
        ...
        children: (0, import_jsx_runtime290.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || (0, import_jsx_runtime290.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || (0, import_jsx_runtime290.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
var Rating = factory((_props, ref) => {
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react377.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react377.useState)(-1);
  const [isOutside, setOutside] = (0, import_react377.useState)(true);
  ...
  return (0, import_jsx_runtime291.jsx)(RatingProvider, { value: { getStyles }, children: (0, import_jsx_runtime291.jsx)(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react378.useState)(defaultOpened);
  const boundaryRef = (0, import_react378.useRef)(null);
  ...
  const handleMouseMove = (0, import_react378.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime292.jsxs)(import_jsx_runtime292.Fragment, { children: [
    (0, import_jsx_runtime292.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime292.jsx)(
      Box,
      {
        ...others,
        ...getStyles("tooltip", {
    ...
    (0, import_react380.cloneElement)(children, {
      ..._childrenProps,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react381.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react381.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  ...
  return (0, import_jsx_runtime293.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime293.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react384.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const onChange = (0, import_react384.useCallback)(
    (_opened) => {
      setUncontrolledOpened(_opened);
      if (_opened) {
        setCurrentId(uid);
...
var Tooltip = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const arrowRef = (0, import_react386.useRef)(null);
  ...
  (0, import_react386.useEffect)(() => {
    const targetNode = target instanceof HTMLElement ? target : typeof target === "string" ? document.querySelector(target) : (target == null ? void 0 : target.current) || null;
    if (targetNode) {
  ...
  if (target) {
    ...
    return (0, import_jsx_runtime294.jsx)(import_jsx_runtime294.Fragment, { children: (0, import_jsx_runtime294.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime294.jsx)(
      Transition,
      {
        ...transition2,
        keepMounted,
        ...
        children: (transitionStyles) => (0, import_jsx_runtime294.jsxs)(
          Box,
          {
            ...others,
  ...
  return (0, import_jsx_runtime294.jsxs)(import_jsx_runtime294.Fragment, { children: [
    ...
    (0, import_react386.cloneElement)(
      _children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return (0, import_jsx_runtime295.jsx)(Tooltip.Floating, { disabled: !tooltip, label: tooltip, children: (0, import_jsx_runtime295.jsx)(
    Box,
    {
      component: "circle",
      ...others,
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset2 }, index3) => (0, import_react388.createElement)(
    Curve,
    {
      ...data,
      key: index3,
  ...
  return (0, import_jsx_runtime296.jsxs)(Box, { ...getStyles("root"), size: size2, ref, ...others, children: [
    (0, import_jsx_runtime296.jsx)("svg", { ...getStyles("svg"), children: curves }),
    label && (0, import_jsx_runtime296.jsx)("div", { ...getStyles("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const [key, setKey] = (0, import_react389.useState)(randomId());
  const [parent, setParent] = (0, import_react389.useState)(null);
  const [refs, setRefs] = (0, import_react389.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react389.createElement)(
    Box,
    {
      ...getStyles("control"),
    ...
    (0, import_react389.createElement)(
      "input",
      {
        ...getStyles("input"),
    ...
    (0, import_react389.createElement)(
      ...
      (0, import_jsx_runtime297.jsx)("span", { ...getStyles("innerLabel"), children: item.label })
    )
  ));
  ...
  return (0, import_jsx_runtime297.jsxs)(
    Box,
    {
      ...
      children: [
        typeof _value === "string" && (0, import_jsx_runtime297.jsx)(
          FloatingIndicator,
          {
            target: refs[_value],
            parent,
...
var Select = factory((_props, ref) => {
  ...
  const parsedData = (0, import_react390.useMemo)(() => getParsedComboboxData(data), [data]);
  const retainedSelectedOptions = (0, import_react390.useRef)({});
  const optionsLockup = (0, import_react390.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
  ...
  (0, import_react390.useEffect)(() => {
    ...
    if (!controlled && !searchControlled) {
      handleSearchChange(
        typeof _value === "string" ? _value in optionsLockup ? (_a = optionsLockup[_value]) == null ? void 0 : _a.label : ((_b = retainedSelectedOptions.current[_value]) == null ? void 0 : _b.label) || "" : ""
      );
    }
  }, [optionsLockup, _value]);
  (0, import_react390.useEffect)(() => {
  ...
  const clearButton = (0, import_jsx_runtime298.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime298.jsxs)(import_jsx_runtime298.Fragment, { children: [
    (0, import_jsx_runtime298.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime298.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: (0, import_jsx_runtime298.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              __defaultRightSection: (0, import_jsx_runtime298.jsx)(
                Combobox.Chevron,
                {
                  size: size2,
                  error,
...
var SemiCircleProgress = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime299.jsxs)(Box, { ref, size: size2, ...getStyles("root"), ...others, children: [
    label && (0, import_jsx_runtime299.jsx)("p", { ...getStyles("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime299.jsxs)("svg", { width: size2, height: size2 / 2, ...getStyles("svg"), children: [
...
function SimpleGridMediaVariables({
  ...
  return (0, import_jsx_runtime300.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return (0, import_jsx_runtime300.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  ...
  const responsiveClassName = useRandomClassName();
  if (type === "container") {
    return (0, import_jsx_runtime301.jsxs)(import_jsx_runtime301.Fragment, { children: [
      (0, import_jsx_runtime301.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
      (0, import_jsx_runtime301.jsx)("div", { ...getStyles("container"), children: (0, import_jsx_runtime301.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime301.jsxs)(import_jsx_runtime301.Fragment, { children: [
    (0, import_jsx_runtime301.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime301.jsx)(Box, { ref, ...getStyles("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime302.jsx)(Box, { ref, ...getStyles("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react396.forwardRef)(
...
var Thumb3 = (0, import_react397.forwardRef)(
  ({
    max,
    min,
    value,
    ...
    const { getStyles } = useSliderContext();
    const [focused, setFocused] = (0, import_react397.useState)(false);
        ...
        children: [
          ...
          (0, import_jsx_runtime305.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime305.jsx)("div", { ...getStyles("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min, max, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index3) => (0, import_react398.createElement)(
    Box,
    {
    ...
    mark.label && (0, import_jsx_runtime306.jsx)("div", { ...getStyles("markLabel"), children: mark.label })
  ));
  return (0, import_jsx_runtime306.jsx)("div", { children: items });
}
...
function Track({
  ...
  const { getStyles } = useSliderContext();
  return (0, import_jsx_runtime307.jsx)(Box, { ...getStyles("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime307.jsxs)(Box, { ...getStyles("track"), mod: { inverted, disabled }, children: [
    ...
    children,
    (0, import_jsx_runtime307.jsx)(Marks, { ...others, offset: marksOffset, disabled, inverted })
  ] }) });
}
...
var Slider = factory((_props, ref) => {
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react400.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react400.useRef)(_value);
  const onChangeEndRef = (0, import_react400.useRef)(onChangeEnd);
  (0, import_react400.useEffect)(() => {
    onChangeEndRef.current = onChangeEnd;
  }, [onChangeEnd]);
  const root = (0, import_react400.useRef)(null);
  const thumb = (0, import_react400.useRef)(null);
  ...
  const handleChange = (0, import_react400.useCallback)(
    ({ x }) => {
      if (!disabled) {
  ...
  const handleScrubEnd = (0, import_react400.useCallback)(() => {
  ...
  const callOnChangeEnd = (0, import_react400.useCallback)(
    (value2) => {
      if (!disabled && onChangeEndRef.current) {
  ...
  return (0, import_jsx_runtime308.jsx)(SliderProvider, { value: { getStyles }, children: (0, import_jsx_runtime308.jsxs)(
    SliderRoot,
    {
      ...others,
      ...
      children: [
        (0, import_jsx_runtime308.jsx)(
          Track,
          {
            ...
            children: (0, import_jsx_runtime308.jsx)(
              Thumb3,
              {
                max: domainMax,
                min: domainMin,
        ...
        (0, import_jsx_runtime308.jsx)("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
      ]
    }
  ) });
});
...
var RangeSlider = factory((_props, ref) => {
  ...
  const containerRef = (0, import_react401.useRef)(null);
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react401.useState)(-1);
  ...
  const thumbs = (0, import_react401.useRef)([]);
  const root = (0, import_react401.useRef)(null);
  const thumbIndex = (0, import_react401.useRef)(void 0);
  const [domainMin, domainMax] = domain || [min, max];
  const positions = [
  ...
  return (0, import_jsx_runtime309.jsx)(SliderProvider, { value: { getStyles }, children: (0, import_jsx_runtime309.jsxs)(
    SliderRoot,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime309.jsx)("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }),
        (0, import_jsx_runtime309.jsx)("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })
      ]
    }
  ) });
});
...
var Space = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime310.jsx)(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime311.jsxs)(
    Box,
    {
      ...getStyles("root"),
      id: _id,
      ...
      ...others,
      children: [
        spoiler && (0, import_jsx_runtime311.jsx)(
          Anchor,
          {
            component: "button",
            type: "button",
        ...
        (0, import_jsx_runtime311.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime311.jsx)("div", { ref: contentRef, children })
          }
        )
      ]
    }
...
var Stack = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime312.jsx)(Box, { ref, ...getStyles("root"), variant, ...others });
});
...
var getStepFragment = (Fragment26, step) => {
  if (typeof Fragment26 === "function") {
    return (0, import_jsx_runtime314.jsx)(Fragment26, { step: step || 0 });
  }
  return Fragment26;
};
var defaultProps94 = {
...
var StepperStep = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime314.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        withIcon && (0, import_jsx_runtime314.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime314.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime314.jsx)(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime314.jsx)(
              "span",
              {
                ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi }),
                children: loading ? (0, import_jsx_runtime314.jsx)(
                  Loader,
                  {
                    color: "var(--mantine-color-white)",
                ...
                ) : getStepFragment(completedIcon, step) || (0, import_jsx_runtime314.jsx)(CheckIcon, { size: "60%" })
              }
            ) }),
            state !== "stepCompleted" ? loading ? (0, import_jsx_runtime314.jsx)(
              Loader,
              {
                ...ctx.getStyles("stepLoader", stylesApi),
                size: "calc(var(--stepper-icon-size) / 2)",
          ...
          orientation === "vertical" && (0, import_jsx_runtime314.jsx)(
            "span",
            {
        ...
        (label || description) && (0, import_jsx_runtime314.jsxs)(
          "span",
          {
            ...
            children: [
              label && (0, import_jsx_runtime314.jsx)("span", { ...ctx.getStyles("stepLabel", stylesApi), children: getStepFragment(label, step) }),
              description && (0, import_jsx_runtime314.jsx)("span", { ...ctx.getStyles("stepDescription", stylesApi), children: getStepFragment(description, step) })
            ]
          }
        )
      ]
...
var Stepper = factory((_props, ref) => {
  ...
  const convertedChildren = import_react407.Children.toArray(children);
  ...
  const items = _children.reduce(
    (acc, item, index3) => {
      ...
      acc.push(
        (0, import_react407.cloneElement)(item, {
      ...
      if (orientation === "horizontal" && index3 !== _children.length - 1) {
        acc.push(
          (0, import_react407.createElement)(
            "div",
            {
              ...getStyles("separator"),
  ...
  return (0, import_jsx_runtime315.jsx)(StepperProvider, { value: { getStyles, orientation, iconPosition }, children: (0, import_jsx_runtime315.jsxs)(Box, { ...getStyles("root"), ref, size: size2, ...others, children: [
    ...
    content && (0, import_jsx_runtime315.jsx)("div", { ...getStyles("content"), children: content })
  ] }) });
});
...
var SwitchGroupContext = (0, import_react408.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react408.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", null, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime316.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: (0, import_jsx_runtime316.jsx)(
    Input.Wrapper,
    {
      size: size2,
      ref,
      ...
      children: (0, import_jsx_runtime316.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
        ...
        (0, import_jsx_runtime317.jsxs)(
          Box,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime317.jsx)("span", { ...getStyles("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime320.jsxs)(import_jsx_runtime320.Fragment, { children: [
    data.caption && (0, import_jsx_runtime320.jsx)(TableCaption, { children: data.caption }),
    data.head && (0, import_jsx_runtime320.jsx)(TableThead, { children: (0, import_jsx_runtime320.jsx)(TableTr, { children: data.head.map((item, index3) => (0, import_jsx_runtime320.jsx)(TableTh, { children: item }, index3)) }) }),
    data.body && (0, import_jsx_runtime320.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime320.jsx)(TableTr, { children: row.map((item, index3) => (0, import_jsx_runtime320.jsx)(TableTd, { children: item }, index3)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime320.jsx)(TableTfoot, { children: (0, import_jsx_runtime320.jsx)(TableTr, { children: data.foot.map((item, index3) => (0, import_jsx_runtime320.jsx)(TableTh, { children: item }, index3)) }) })
  ] });
}
...
var TableScrollContainer = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime321.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime321.jsx)("div", { ...getStyles("scrollContainerInner"), children })
    }
  );
});
...
var Table = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime322.jsx)(
    TableProvider,
    {
      ...
      children: (0, import_jsx_runtime322.jsx)(
        Box,
        {
          component: "table",
          variant,
          ...
          ...getStyles("table"),
          ...others,
          children: children || !!data && (0, import_jsx_runtime322.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TableOfContents = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime323.jsx)(Box, { ref, variant, ...getStyles("root"), ...others, children: controls });
});
...
var TabsTab = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime327.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime327.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime327.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children }),
        rightSection && (0, import_jsx_runtime327.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var Tabs = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime328.jsx)(
    TabsProvider,
    {
      ...
      children: (0, import_jsx_runtime328.jsx)(
        Box,
        {
          ref,
          id: uid,
...
var TagsInput = factory((_props, ref) => {
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react422.useRef)(null);
  ...
  const values2 = _value.map((item, index3) => (0, import_jsx_runtime330.jsx)(
    Pill,
    {
  ...
  (0, import_react422.useEffect)(() => {
    if (selectFirstOptionOnChange) {
      combobox.selectFirstOption();
    }
  }, [selectFirstOptionOnChange, _value, _searchValue]);
  const clearButton = (0, import_jsx_runtime330.jsx)(
    Combobox.ClearButton,
    {
      ...clearButtonProps,
      onClear: () => {
  ...
  return (0, import_jsx_runtime330.jsxs)(import_jsx_runtime330.Fragment, { children: [
    (0, import_jsx_runtime330.jsxs)(
      Combobox,
      {
        store: combobox,
        classNames: resolvedClassNames,
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime330.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime330.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              mod,
              attributes,
              children: (0, import_jsx_runtime330.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles("pillsList"), children: [
                values2,
                (0, import_jsx_runtime330.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime330.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime331.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime332.jsx)(Box, { ref, ...getStyles("root"), ...others });
});
...
var TimelineItem = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const stylesApiProps = { classNames, styles };
  return (0, import_jsx_runtime334.jsxs)(
    Box,
    {
      ...ctx.getStyles("item", { ...stylesApiProps, className, style }),
      ...
      children: [
        ...
        (0, import_jsx_runtime334.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          title && (0, import_jsx_runtime334.jsx)("div", { ...ctx.getStyles("itemTitle", stylesApiProps), children: title }),
          (0, import_jsx_runtime334.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  ...
  const _children = import_react427.Children.toArray(children);
  const items = _children.map(
    (item, index3) => {
      var _a, _b;
      return (0, import_react427.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return (0, import_jsx_runtime335.jsx)(TimelineProvider, { value: { getStyles }, children: (0, import_jsx_runtime335.jsx)(Box, { ...getStyles("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
...
var Title = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime337.jsx)(
    Box,
    {
      ...getStyles("root"),
      component: `h${order}`,
...
function TreeNode({
  ...
  const ref = (0, import_react430.useRef)(null);
  const nested = (node.children || []).map((child) => (0, import_jsx_runtime338.jsx)(
    TreeNode,
    {
      node: child,
      flatValues,
  ...
  return (0, import_jsx_runtime338.jsxs)(
    "li",
    {
      ...getStyles("node", {
      ...
      children: [
        typeof renderNode === "function" ? renderNode({
          ...
          elementProps
        }) : (0, import_jsx_runtime338.jsx)("div", { ...elementProps, children: node.label }),
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime338.jsx)(Box, { component: "ul", role: "group", ...getStyles("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
function useTree({
  ...
  const [data, setData] = (0, import_react433.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react433.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react433.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react433.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react433.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react433.useState)(null);
  const initialize = (0, import_react433.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react433.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react433.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react433.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react433.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react433.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react433.useCallback)(
  ...
  const select = (0, import_react433.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react433.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react433.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react433.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react433.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react433.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react433.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react434.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react434.useEffect)(() => {
    controller.initialize(data);
  }, [data]);
  const nodes = data.map((node, index3) => (0, import_jsx_runtime341.jsx)(
    TreeNode,
    {
      node,
      getStyles,
...
var Typography = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime342.jsx)(Box, { ref, ...getStyles("root"), ...others });
});
...
var Ie = (e) => ne(De, e, true);
var oe = (e) => (0, import_jsx_runtime343.jsxs)(Stack, { gap: 0, className: "bn-tooltip", children: [
  (0, import_jsx_runtime343.jsx)(Text, { size: "sm", lineClamp: 5, children: e.mainTooltip }),
  e.secondaryTooltip && (0, import_jsx_runtime343.jsx)(Text, { size: "xs", lineClamp: 5, children: e.secondaryTooltip })
] });
var O = (0, import_react437.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    Vo(S, false);
    const [x, y2] = (0, import_react437.useState)(false), k = o ? (0, import_jsx_runtime343.jsx)(
      Button,
      {
        "aria-label": g,
        className: t,
        onMouseDown: (w) => {
          Wo() && w.currentTarget.focus();
        },
        onClick: (w) => {
          y2(true), u == null || u(w);
        },
        onPointerLeave: () => y2(false),
        "aria-pressed": l,
    ...
    return r ? (0, import_jsx_runtime343.jsx)(
      Tooltip,
      {
        disabled: x,
        withinPortal: false,
        label: (0, import_jsx_runtime343.jsx)(
          oe,
          {
            mainTooltip: r,
            secondaryTooltip: i
...
var Re = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    text: o,
    icon: r,
  ...
  Vo(g, false);
  const [b, S] = (0, import_react437.useState)(false), x = (0, import_jsx_runtime343.jsxs)(
    Chip,
    {
      className: t,
      checked: i === true,
      ...
      ref: n,
      children: [
        (0, import_jsx_runtime343.jsx)("span", { children: r }),
        (0, import_jsx_runtime343.jsx)("span", { children: o })
      ]
    }
  );
  return !a || b ? x : (0, import_jsx_runtime343.jsx)(
    Tooltip,
    {
      refProp: "rootRef",
      withinPortal: false,
...
var Be = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime343.jsx)(Group, { className: t, ref: n, children: o });
});
var Ee = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    headerText: r,
  ...
  Vo(u, false);
  const g = (0, import_react437.useRef)(null);
  return (0, import_react437.useEffect)(() => {
    var b;
    i && ((b = g.current) == null || b.scrollIntoView({
      behavior: "smooth",
      block: "center"
    }));
  }, [i]), (0, import_jsx_runtime343.jsxs)(
    Card,
    {
      ...
      ref: To([n, g]),
      children: [
        r && (0, import_jsx_runtime343.jsx)(Text, { className: "bn-header-text", children: r }),
        o
      ]
    }
  );
});
var Le = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime343.jsx)(Card.Section, { className: t, ref: n, children: o });
});
var ze = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime343.jsx)(
    Divider,
    {
      className: t,
      label: (0, import_jsx_runtime343.jsx)(Text, { children: o }),
      ref: n
    }
  );
});
var je = (0, import_react437.forwardRef)((e, n) => {
  const { authorInfo: t, timeString: o, edited: r, ...i } = e, a = y();
  return Vo(i, false), t === "loading" ? (0, import_jsx_runtime343.jsxs)(Group, { children: [
    (0, import_jsx_runtime343.jsx)(Skeleton, { height: 24, width: 24 }),
    (0, import_jsx_runtime343.jsx)("div", { children: (0, import_jsx_runtime343.jsx)(Skeleton, { height: 12, width: 100 }) })
  ] }) : (0, import_jsx_runtime343.jsxs)(Group, { children: [
    (0, import_jsx_runtime343.jsx)(
      Avatar,
      {
        src: t.avatarUrl,
    ...
    (0, import_jsx_runtime343.jsxs)(Text, { fz: "sm", fw: "bold", children: [
      t.username,
      (0, import_jsx_runtime343.jsxs)(Text, { fz: "xs", c: "dimmed", span: true, ml: "xs", children: [
        o,
        " ",
        r && `(${a.comments.edited})`
      ] })
...
var $e = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    showActions: o,
    authorInfo: r,
    ...
    children: c,
    ...u
  } = e, { hovered: g, ref: b } = useHover2(), { focused: S, ref: x } = useFocusWithin(), y2 = To([n, b]);
  return Vo(u, false), (0, import_jsx_runtime343.jsxs)(Group, { pos: "relative", ref: y2, className: t, children: [
    l && (o === true || o === void 0 || o === "hover" && g || S) ? (0, import_jsx_runtime343.jsx)(
      Group,
      {
        ref: x,
        style: {
    ...
    (0, import_jsx_runtime343.jsx)(je, { ...e }),
    c
  ] });
});
var Ae = (0, import_react437.forwardRef)((e, n) => {
  ...
  return (0, import_jsx_runtime343.jsx)(
    Ft,
    {
      ...
      onFocus: r,
      onBlur: i,
      children: (0, import_jsx_runtime343.jsx)(
        Ko,
        {
...
var _e = () => {
  ...
  return (0, import_jsx_runtime343.jsx)(Bt, { blockTypeSelectItems: [], children: e });
};
var Ve = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    name: o,
    label: r,
  ...
  return Vo(w), (0, import_jsx_runtime343.jsx)(
    TextInput,
    {
      size: "xs",
      className: U(
...
var Ge = (0, import_react437.createContext)(void 0);
var He = (e) => {
  const { children: n, onOpenChange: t, position: o, sub: r, ...i } = e;
  return Vo(i), r ? (0, import_jsx_runtime343.jsx)(
    Menu.Sub,
    {
...
var Ke = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, icon: r, checked: i, subTrigger: a, onClick: l, ...c } = e;
  return Vo(c, false), a ? (0, import_jsx_runtime343.jsx)(
    Menu.Sub.Item,
    {
      className: t,
      ref: n,
      leftSection: r,
      rightSection: i ? (0, import_jsx_runtime343.jsx)(CheckIcon, { size: 10 }) : i === false ? (0, import_jsx_runtime343.jsx)("div", { className: "bn-tick-space" }) : null,
      onClick: l,
      ...c,
      children: o
    }
...
var Ue = (e) => {
  ...
  return Vo(o), t ? (0, import_jsx_runtime343.jsx)(Menu.Sub.Target, { children: n }) : (0, import_jsx_runtime343.jsx)(Menu.Target, { children: n });
};
var We = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    sub: r,
  ...
  Vo(i);
  const a = (0, import_react437.useContext)(Ge);
  return r ? (0, import_jsx_runtime343.jsx)(
    Menu.Sub.Dropdown,
    {
      className: t,
...
var qe = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return Vo(o), (0, import_jsx_runtime343.jsx)(Menu.Divider, { className: t, ref: n });
});
var Ze = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime343.jsx)(Menu.Label, { className: t, ref: n, children: o });
});
var Je = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
  ...
  return Vo(g, false), r ? (0, import_jsx_runtime343.jsx)(
    ActionIcon,
    {
      size: 24,
      className: t,
...
var Qe = (0, import_react437.forwardRef)((e, n) => {
  ...
  return Vo(c), (0, import_jsx_runtime343.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime343.jsxs)(
    Tabs,
    {
      value: i,
      defaultValue: r,
      onChange: a,
      children: [
        l && (0, import_jsx_runtime343.jsx)(LoadingOverlay, { visible: l }),
        (0, import_jsx_runtime343.jsx)(Tabs.List, { children: o.map((u) => (0, import_jsx_runtime343.jsx)(
          Tabs.Tab,
          {
        ...
        o.map((u) => (0, import_jsx_runtime343.jsx)(Tabs.Panel, { value: u.name, children: u.tabPanel }, u.name))
      ]
    }
  ) });
});
var Xe = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, onClick: r, label: i, ...a } = e;
  return Vo(a), (0, import_jsx_runtime343.jsx)(
    Button,
    {
      size: "xs",
      "aria-label": i,
...
var Ye = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, accept: o, value: r, placeholder: i, onChange: a, ...l } = e;
  return Vo(l), (0, import_jsx_runtime343.jsx)(
    FileInput,
    {
      size: "xs",
      className: t,
...
var et = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime343.jsx)("div", { className: t, ref: n, children: o });
});
var tt = (0, import_react437.forwardRef)((e, n) => {
...
var nt = (e) => {
  ...
  return Vo(r), (0, import_jsx_runtime343.jsx)(Popover, { withinPortal: false, opened: n, position: t, children: o });
};
var ot = (e) => {
  const { children: n, ...t } = e;
  return Vo(t), (0, import_jsx_runtime343.jsx)(PopoverTarget, { children: n });
};
var rt = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    variant: r,
  ...
  return Vo(i), (0, import_jsx_runtime343.jsx)(PopoverDropdown, { className: t, ref: n, children: o });
});
var st = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r, false), (0, import_jsx_runtime343.jsx)(
    Group,
    {
...
var it = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    icon: r,
...
var at = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, id: r, ...i } = e;
  return Vo(i), (0, import_jsx_runtime343.jsx)(
    Stack,
    {
      gap: 0,
      className: t,
...
var lt = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime343.jsx)(Group, { className: t, ref: n, children: (0, import_jsx_runtime343.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o }) });
});
var ct = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: a, ...l } = e;
  Vo(l);
  const c = (0, import_react437.useRef)(null);
  return (0, import_react437.useEffect)(() => {
    if (!c.current || !o)
      return;
    const u = zl(
  ...
  }, [o]), (0, import_jsx_runtime343.jsxs)(
    Group,
    {
      gap: 0,
      className: t,
      ...
      children: [
        i.icon && (0, import_jsx_runtime343.jsx)(
          Group,
          {
        ...
        (0, import_jsx_runtime343.jsxs)(Stack, { gap: 0, className: "bn-mt-suggestion-menu-item-body", children: [
          (0, import_jsx_runtime343.jsx)(Text, { className: "bn-mt-suggestion-menu-item-title", children: i.title }),
          (0, import_jsx_runtime343.jsx)(Text, { className: "bn-mt-suggestion-menu-item-subtitle", children: i.subtext })
        ] }),
        i.badge && (0, import_jsx_runtime343.jsx)(
          Group,
          {
            "data-position": "right",
            className: "bn-mt-suggestion-menu-item-section",
            children: (0, import_jsx_runtime343.jsx)(Badge, { size: "xs", children: i.badge })
          }
        )
      ]
    }
...
var ut = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, children: o, ...r } = e;
  return Vo(r), (0, import_jsx_runtime343.jsx)(Group, { className: t, ref: n, children: o });
});
var dt = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, ...o } = e;
  return Vo(o), (0, import_jsx_runtime343.jsx)(Loader, { className: t, type: "dots", size: 16, ref: n });
});
var mt = (0, import_react437.forwardRef)((e, n) => {
...
var ft = (0, import_react437.forwardRef)((e, n) => {
  ...
  return Vo(i), (0, import_jsx_runtime343.jsx)(
    Group,
    {
      ...
      ref: n,
      children: (0, import_jsx_runtime343.jsx)(Group, { className: "bn-mt-suggestion-menu-item-title", children: o })
    }
  );
});
var gt = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, isSelected: o, onClick: r, item: i, id: a, ...l } = e;
  Vo(l);
  const c = (0, import_react437.useRef)(null);
  return (0, import_react437.useEffect)(() => {
...
var bt = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
...
var ht = (0, import_react437.forwardRef)((e, n) => {
  const { children: t, className: o, onMouseDown: r, onClick: i, ...a } = e;
  return Vo(a, false), (0, import_jsx_runtime343.jsx)(
    Button,
    {
      className: o,
      ref: n,
...
var pt = (0, import_react437.forwardRef)((e, n) => {
  const {
    className: t,
    children: o,
    draggable: r,
  ...
  return Vo(u, false), (0, import_jsx_runtime343.jsx)(
    Button,
    {
      className: t,
      ref: n,
...
var D = (0, import_react437.forwardRef)(
  (e, n) => {
    const {
      className: t,
      children: o,
    ...
    Vo(l);
    const { ref: c, focused: u } = useFocusWithin(), g = useFocusTrap(u), b = mergeRefs(n, c, g);
    return (0, import_jsx_runtime343.jsx)(
      Flex,
      {
        className: t,
...
var G = import_react437.default.createContext && import_react437.default.createContext(re);
...
function F2() {
  return F2 = Object.assign ? Object.assign.bind() : function(e) {
...
function M(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? H(Object(t), true).forEach(function(o) {
      wt(e, o, t[o]);
...
function se(e) {
  return e && e.map((n, t) => import_react437.default.createElement(n.tag, M({
    key: t
  }, n.attr), se(n.child)));
}
function Nt(e) {
  return (n) => import_react437.default.createElement(Tt, F2({
    attr: M({}, e.attr)
  }, n), se(e.child));
}
function Tt(e) {
  var n = (t) => {
    ...
    return t.className && (c = t.className), e.className && (c = (c ? c + " " : "") + e.className), import_react437.default.createElement("svg", F2({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, o, a, {
      ...
      width: l,
      xmlns: "http://www.w3.org/2000/svg"
    }), i && import_react437.default.createElement("title", null, i), e.children);
  };
  return G !== void 0 ? import_react437.default.createElement(G.Consumer, null, (t) => n(t)) : n(re);
}
function kt(e) {
...
var I = (0, import_react437.forwardRef)((e, n) => {
  const { className: t, items: o, isDisabled: r, ...i } = e;
  Vo(i);
  const a = o.filter((l) => l.isSelected)[0];
  return a ? (0, import_jsx_runtime343.jsxs)(
    Menu,
    {
      withinPortal: false,
      transitionProps: {
      ...
      middlewares: { flip: true, shift: true, inline: false, size: true },
      children: [
        (0, import_jsx_runtime343.jsx)(Menu.Target, { children: (0, import_jsx_runtime343.jsx)(
          Button,
          {
            onMouseDown: (l) => {
              Wo() && l.currentTarget.focus();
            },
            leftSection: a.icon,
            rightSection: (0, import_jsx_runtime343.jsx)(kt, {}),
            size: "xs",
            variant: "subtle",
            disabled: r,
            children: a.text
        ...
        (0, import_jsx_runtime343.jsx)(Menu.Dropdown, { className: t, ref: n, children: o.map((l) => (0, import_jsx_runtime343.jsx)(
          Menu.Item,
          {
            onClick: l.onClick,
            leftSection: l.icon,
            rightSection: l.isSelected ? (0, import_jsx_runtime343.jsx)(CheckIcon, { size: 10, className: "bn-tick-icon" }) : (
              // Ensures space for tick even if item isn't currently selected.
              (0, import_jsx_runtime343.jsx)("div", { className: "bn-tick-space" })
            ),
...
var Pt = {
  ...
  Generic: {
    ...
    Form: {
      Root: (e) => (0, import_jsx_runtime343.jsx)("div", { children: e.children }),
      TextInput: Ve
    },
    Menu: {
      Root: He,
...
var Ft = (e) => {
  const { className: n, theme: t, ...o } = e, r = F(), i = jr(), a = (r == null ? void 0 : r.colorSchemePreference) || i, l = (0, import_react437.useCallback)(
    (b) => {
    ...
    [a, t]
  ), c = (0, import_react437.useContext)(MantineContext), u = typeof t == "string" ? t : a !== "no-preference" ? a : "light", g = (0, import_jsx_runtime343.jsx)(Tn.Provider, { value: Pt, children: (0, import_jsx_runtime343.jsx)(
    Ll,
    {
  ...
  return c ? g : (0, import_jsx_runtime343.jsx)(
    MantineProvider,
    {
