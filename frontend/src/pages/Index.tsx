    ...
    <div className="flex h-full bg-background">
      ...
      >
        {!sidebarCollapsed && (
          <button
            ...
            title={t('components.Index.hideSidebarTask', 'Ẩn sidebar task')}
            aria-label={t('components.Index.hideTaskSidebar', 'Hide task sidebar')}
          >
      ...
      {sidebarCollapsed && (
        ...
        onClick={toggleSidebar}
            ...
            title={t('components.Index.showSidebarTask', 'Hiện sidebar task')}
            aria-label={t('components.Index.showTaskSidebar', 'Show task sidebar')}
          >
